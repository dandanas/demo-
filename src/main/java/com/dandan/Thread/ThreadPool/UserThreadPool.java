...
public class UserThreadPool {
    public static void main(String[] args) {
        ...
        //缓存队列设置默认额长度为2，为了快速除法rejectHandler
        ...
        ThreadPoolExecutor threadPoolExecutorFirst = new ThreadPoolExecutor(1, 3, 60, TimeUnit.SECONDS, queue, f1, userRejectHandler);
        //利用第二个线程工厂实例创建第二个线程池
        ThreadPoolExecutor threadPoolExecutorSecond = new ThreadPoolExecutor(1, 3, 60, TimeUnit.SECONDS, queue, f2, userRejectHandler);
